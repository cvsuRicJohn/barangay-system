...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        try {
            ...
            $columnCheckStmt = $pdo->prepare("SHOW COLUMNS FROM first_time_job_seeker_requests LIKE 'user_id'");
            ...
            header("Location: first-time-job-seeker.php?success=1");
            exit();
        } catch (PDOException $e) {
...
<nav class="main-nav" id="mainNav">
  ...
  <a href="../profile.php"><i class="fas fa-user"></i> My Profile</a>
    ...
    <!-- Cover Photo -->
    <div class="header-banner">First Time Job Seeker Form</div>
