...
<nav class="main-nav" id="mainNav">
  ...
  <a href="../profile.php"><i class="fas fa-user"></i> My Profile</a>
    ...
    <!-- Cover Photo -->
    <div class="header-banner">Certificate of Good Moral Form</div>
...
<form method="POST" action="certificate-of-good-moral.php" id="goodMoralForm">
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="date" name="date_of_birth" class="form-control" required readonly value="<?php echo htmlspecialchars($_POST['date_of_birth'] ?? ($user_data['dob'] ?? '')); ?>">
        </div>
        <div class="form-group col-md-3">
            <label>Age *</label>
