...
$sql = "SELECT full_name, age, civil_status, address, purpose, shipping_method, submitted_at 
        FROM certificate_of_good_moral_requests WHERE id = ?";
...
if ($data) {
    // Load Word template
    $template = new TemplateProcessor('good-moral-template.docx');
    ...
    $filename = 'Good_Moral_Certification_' . $id . '.docx';
